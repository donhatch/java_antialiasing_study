...
#define PRINTARRAY(x) System.out.println("        " + #x + " = " + com.donhatchsw.util.Arrays.toStringCompact(x))
#define PRINTARRAY_NONCOMPACT(x) System.out.println("        " + #x + " =\n" + com.donhatchsw.util.Arrays.toStringNonCompact(x, "        ", "        "))
#define STRINGIFY(x) com.donhatchsw.util.Arrays.toStringCompact(x)
